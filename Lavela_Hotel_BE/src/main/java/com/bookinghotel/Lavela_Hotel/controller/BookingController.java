...
import com.bookinghotel.Lavela_Hotel.response.RoomResponse;
import com.bookinghotel.Lavela_Hotel.service.IBookingService;
...
public class BookingController {
    ...
    public ResponseEntity<List<BookingResponse>> getAllBookings(){
        List<BookedRoom> bookings = bookingService.getAlllBookings();
    ...
    public ResponseEntity<?> saveBooking(@PathVariable Long roomId,
        ...
        try{
            String confirmationCode = bookingService.saveBoking(roomId, bookingRequest);
